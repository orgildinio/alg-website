"""
Composite script for Provence Globe hero image — v2.
Output canvas is 4:3 landscape (1600×1200) to fit the hero box exactly.
Four bulbs (smallest to largest): LTG165V_CB, LTG165V_MB, LTG25V_MB, LTG40V_MB-SV(1)
Bulbs are base-aligned, preserve relative size differences, centered horizontally.
"""
...
# Scale so tallest bulb fills 90% of canvas height, others scale proportionally
