"""
Composite script for Brighton Tubular hero image — v4.
Three new bulbs: LVTS-RD10, LVTS-RD12, LVTS-RD14 (all white background, need rembg)
Same treatment: rembg removal, base-aligned horizontal composite.
"""
