#!/usr/bin/env python3
"""
Remove backgrounds from 4 LTCA10 flame-tip bulb images and composite them into a
horizontal group shot matching the S.png reference layout.

Order (left to right):
  1. LTCA12F12  (frosted, E12 candelabra)
  2. LTCA12C12  (clear, E12 candelabra)
  3. LTCA12F26  (frosted, E26 medium)
  4. LTCA12C26  (clear, E26 medium)
"""
import io, os
...
SOURCES = [
    '/home/ubuntu/upload/LTCA12F12.png',
    '/home/ubuntu/upload/LTCA12C12.png',
    '/home/ubuntu/upload/LTCA12F26.png',
    '/home/ubuntu/upload/LTCA12C26.png',
]

OUT_DIR = '/home/ubuntu/alg-website/public/images/nostalgic-decor'
os.makedirs(OUT_DIR, exist_ok=True)
OUT_PATH = f'{OUT_DIR}/bauer-ca10-group.png'
