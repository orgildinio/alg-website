"""
Composite script for Brighton Tubular hero image — v5.
Three bulbs: LVTS-TB6 (T6 candelabra smoked), LVTS-TB9 (T9 medium smoked),
             LVTS-TB10 (T10 medium smoked)
Ordered shortest to tallest (TB6, TB9, TB10) — base-aligned horizontal composite.
"""
...
# Order: short T6, medium T9, tall T10
SOURCES = [
    "LVTS-TB6.png",
    "LVTS-TB9.png",
    "LVTS-TB10.png",
