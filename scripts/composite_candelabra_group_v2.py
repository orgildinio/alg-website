"""
Composite script for Glasgow Candelabra hero image — v2.
Applies alpha threshold cleanup after rembg to remove halo artifacts.
...
PADDING  = 80
CANVAS_PAD = 80
ALPHA_THRESHOLD = 30  # pixels with alpha < this are fully transparent
...
def remove_bg(src: Path) -> Image.Image:
    ...
    # threshold cleanup: kill near-transparent pixels
    arr = np.array(img)
