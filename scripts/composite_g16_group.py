#!/usr/bin/env python3
"""
Remove backgrounds from 4 LTG165 G16.5 globe bulb images and composite them into a
horizontal group shot matching the S.png reference layout.

Order (left to right):
  1. LTG165F12  (frosted, E12 candelabra)
  2. LTG165C12  (clear, E12 candelabra)
  3. LTG165F26  (frosted, E26 medium)
  4. LTG165C26  (clear, E26 medium)
"""
import io, os
...
SOURCES = [
    '/home/ubuntu/upload/LTG165F12.png',
    '/home/ubuntu/upload/LTG165C12.png',
    '/home/ubuntu/upload/LTG165F26.png',
    '/home/ubuntu/upload/LTG165C26.png',
]

OUT_DIR = '/home/ubuntu/alg-website/public/images/nostalgic-decor'
os.makedirs(OUT_DIR, exist_ok=True)
OUT_PATH = f'{OUT_DIR}/nelson-g16-group.png'
