#!/usr/bin/env python3
"""
Remove backgrounds from 3 LTG25 G25 globe bulb images and composite them into a
horizontal group shot matching the S.png reference layout.

Order (left to right):
  1. LTG25S  (silver crown / half-mirror)
  2. LTG25F  (frosted)
  3. LTG25C  (clear filament)
"""
import io, os
...
SOURCES = [
    '/home/ubuntu/upload/LTG25S.png',
    '/home/ubuntu/upload/LTG25F.png',
    '/home/ubuntu/upload/LTG25C.png',
]

OUT_DIR = '/home/ubuntu/alg-website/public/images/nostalgic-decor'
os.makedirs(OUT_DIR, exist_ok=True)
OUT_PATH = f'{OUT_DIR}/eames-g25-group.png'
