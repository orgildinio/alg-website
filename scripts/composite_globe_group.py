"""
Composite script for Provence Globe hero image.
Four bulbs: LTG165V_CB (G16.5 candelabra amber), LTG165V_MB (G16.5 medium amber),
            LTG25V_MB (G25 medium amber), LTG40V_MB-SV (G40 medium amber spiral)
...
TARGET_H = 1100   # normalised bulb height
PADDING  = 50     # horizontal gap between bulbs
