  ...
  featured: [
    {
      ...
      dlc: true,
      lineDrawing: null,
      pdpUrl: '/products/titan/',
      cardImage: '/products/titan/assets/hero/fam-titan-01.webp',
    },
    {
      family: 'retroⒶRCH-L1',
      subCategory: 'Retrofit Linear Strip',
      displayEchelon: 'PRO' as const,
      maxWattage: 90,
      skuCount: 4,
      dlc: true,
      lineDrawing: null,
      pdpUrl: '/products/retroarch-l1/',
      cardImage: '/products/retroarch-l1/assets/hero/fam-retroarch-l1.webp',
    },
    {
      family: 'Icarus',
      subCategory: 'Round High Bay',
      displayEchelon: 'ECO' as const,
      maxWattage: 300,
      skuCount: 12,
      dlc: true,
      lineDrawing: null,
      pdpUrl: '/products/icarus/',
      cardImage: '/products/icarus/assets/hero/fam-icarus.webp',
    },
    {
      family: 'Hallmark',
      ...
      dlc: true,
      lineDrawing: null,
      pdpUrl: '/products/hallmark/',
      cardImage: '/products/hallmark/assets/hero/fam-hallmark.webp',
    },
  ],
