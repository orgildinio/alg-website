...
const pllData = {
  ...
  description: 'Biax PLL lamp replacements for 2G11 base fixtures.',
  heroImage: '',
  echelon: undefined,
  keySpecs: {
...
export const siblingFamilies = [
  { slug: 'pl', name: 'Pl', skuCount: 3, tagline: '' },
  { slug: 't5', name: 'T5', skuCount: 3, tagline: '' },
  { slug: 't8', name: 'T8', skuCount: 3, tagline: '' },
  { slug: 'u6', name: 'U6', skuCount: 3, tagline: '' },
];
